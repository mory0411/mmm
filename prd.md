...
#### 웹사이트 진입
**공유 링크 접속:**
- 고유 링크(예: mori.com/r/abc123)로 접속
...
#### 단일 공유 링크
- 고유 해시 코드 기반 (예: mori.com/r/abc123)
...
### / (메인 페이지)
- 서비스 소개 (슬로건, 목표, 사용 방법 안내)
- 관계 생성 버튼 (새로운 관계 시작)
- 공유 링크 입력 필드 (기존 관계 참여)

### /app
- /page.tsx: 메인 페이지 렌더링
- /layout.tsx: 공통 레이아웃 (네비게이션 바, 푸터)
...
**/[hash]/page.tsx:**
- 공유 링크 접속 페이지
- 답변하기 섹션: 오늘의 질문 표시, 답변 입력란
- 지금까지의 답변 보기 섹션: 타임라인 형식의 과거 Q&A
- 역할 선택 모달 (첫 접속 시)
- 새 답변 알림 배지
